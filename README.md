...
cotton-candy : repeating-linear-gradient(0deg, hsl(4.11deg 89.62% 58.43%), hsl(340 100% 83% / 1));

funny-purple : linear-gradient(45deg, hsl(291.24deg 63.72% 42.16%), hsl(66 85% 54% / 1));

blue-shades : linear-gradient(45deg, hsl(231 64% 48% / 1), hsl(261.6deg 51.87% 47.25%), hsl(291.24deg 63.72% 42.16%), hsl(231 64% 48% / 1), hsl(261.6deg 51.87% 47.25%), hsl(291.24deg 63.72% 42.16%));

instagram : linear-gradient(141deg, hsl(261.6deg 82.76% 52.44%) 2%, hsl(322 82% 52% / 1), hsl(23 79% 53% / 1), hsl(49 100% 50% / 1));

lavendar-lemonade: linear-gradient(230deg, hsl(258 95% 75% / 1) 50px, hsl(415 73% 58% / 1), hsl(166 40% 49% / 1));

golden-hour: linear-gradient(132deg, hsl(53.88deg 100% 61.57% / 81%), hsl(45deg 100% 51.37%), hsl(35.76deg 100% 50%), hsl(45deg 100% 51.37%), hsl(54deg 100% 62% / 81%));

rainbow : linear-gradient(135deg, #9C27B0, #2196F3, #03A9F4, #4CAF50, #FFEB3B, #FF9800, #FF5722);

mango-blush : linear-gradient(133deg, hsl(0 48% 47% / 1), hsl(411 95% 54% / 1), hsl(350 49% 68% / 1));
